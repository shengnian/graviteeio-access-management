...
public class ClientRegistrationResponse {
     ...
     * and for the derivation of symmetric encryption key values, as described in Section 10.2 of OpenID Connect
     ...
     *
     * OPTIONAL. Registration Access Token that can be used at the Client Configuration Endpoint to perform subsequent
     ...
     * perform subsequent operations upon the resulting Client registration. Implementations MUST either return both a
     * Client Configuration Endpoint and a Registration Access Token or neither of them.
     */
     ...
     * client_id_issued_at
     *
     * OPTIONAL. Time at which the Client Identifier was issued. Its value is a JSON number representing the number of
     ...
     *
     * REQUIRED if client_secret is issued. Time at which the client_secret will expire or 0 if it will not expire. Its
